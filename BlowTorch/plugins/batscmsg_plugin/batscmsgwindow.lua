...
imgmessage5items(buttonview4, ".kb popup .mp ", ".swchfc auto", ".loadset default", ".kb .mp bk", ".kb .mp sv")
...
imgmessage5items(tv_buttonview1, ".win mainbuffer", ".win mainbuffer;.closewindow", ".win mainbuffer;.closewindow", ".win mainbuffer;.closewindow",  ".win mainbuffer;.closewindow")
