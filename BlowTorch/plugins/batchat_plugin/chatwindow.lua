...
respath = "/storage/emulated/0/BlowTorch/Icons/icons"
...
local dividerHeight = math.floor(2*density);
...
local uiButtonBarHeight = math.floor(20*density)
if(dpi_bucket >= 600) then
	uiButtonBarHeight = 25*density
end
...
function setChatViewPosition(val)
if val == "true" then
option_portrait = true
replacementViewParams = luajava.new(RelativeLayoutParams,displayWidth,WRAP_CONTENT)
replacementViewParams:addRule(RelativeLayout.ALIGN_PARENT_TOP)
replacementViewParams:addRule(RelativeLayout.ALIGN_PARENT_RIGHT)
replacementView:setLayoutParams(replacementViewParams)
mainOutputViewLayoutParams1 = mainOutputViewLayoutParams
mainOutputViewLayoutParams1:addRule(RelativeLayout.BELOW,replacementView:getId())
mainOutputViewLayoutParams1:addRule(RelativeLayout.ABOVE,9108)
mainOutputViewLayoutParams1:addRule(RelativeLayout.ALIGN_PARENT_RIGHT)
mainOutputViewLayoutParams1:addRule(RelativeLayout.ALIGN_PARENT_LEFT)
mainOutputViewLayoutParams1:setMargins(0, 0, 0, 0)
mainOutputView:setLayoutParams(mainOutputViewLayoutParams1)
else
option_portrait = false
replacementViewParams = luajava.new(RelativeLayoutParams,chatwidth-2,WRAP_CONTENT)
replacementViewParams:addRule(RelativeLayout.ALIGN_PARENT_TOP)
replacementViewParams:addRule(RelativeLayout.ALIGN_PARENT_RIGHT)
replacementView:setLayoutParams(replacementViewParams)
mainOutputViewLayoutParams2 = mainOutputViewLayoutParams
--mainOutputViewLayoutParams2:addRule(RelativeLayout.LEFT_OF,replacementView:getId())
mainOutputViewLayoutParams2:addRule(RelativeLayout.ABOVE,9108)
mainOutputViewLayoutParams2:addRule(RelativeLayout.ALIGN_PARENT_LEFT)
mainOutputViewLayoutParams2:addRule(RelativeLayout.ALIGN_PARENT_TOP)
mainOutputViewLayoutParams2:setMargins(0, 0, chatwidth, 0)
mainOutputView:setLayoutParams(mainOutputViewLayoutParams2)
end
end
--setChatViewPosition("true")
...
mainButton:setTextSize(3*density)
